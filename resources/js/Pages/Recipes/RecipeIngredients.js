    ...
    return (
        <section>
            {ingredients.length > 0 &&
                <h2 className="font-medium mt-5 text-lg">Recipe ingredients</h2>
            }
            <ul>
                {ingredients.map(ingredient => (
                    <li key={ingredient.id} className="flex justify-between items-center border-b border-indigo-200 py-2">
